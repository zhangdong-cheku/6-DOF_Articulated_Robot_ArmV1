...
<p align="center">
  <img src="pictures/机械臂.png" width="800"/>
  
本项目是一款低成本、高扩展性的六自由度关节式机械臂，专为机器人爱好者、科研人员和学生设计。支持精准运动控制、路径规划、自定义任务编程，可广泛应用于教学演示、自动化实验、小型生产线作业等场景。​
核心目标：降低机械臂开发门槛，提供从硬件设计到软件控制的完整开源方案，助力开发者快速搭建属于自己的机械臂系统。
...
<p align="center">
  <img src="pictures/机械臂.gif" width="800"/>
