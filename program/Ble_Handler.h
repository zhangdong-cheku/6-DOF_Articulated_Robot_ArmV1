...
#define DATA_TYPE_FEEDBACK_REQ 0x10   //!< 反馈请求 - 主机轮询当前角度
#define DATA_TYPE_MODE      0x20       //!< 模式控制 - 运行/待机模式切换（0=STANDBY, 非0=RUN）
